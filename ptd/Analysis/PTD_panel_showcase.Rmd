---
title: "Precision Trial Designer showcase panel"
author: 
  - name: Giorgio Melloni, PhD
    affiliation: European Institute of Oncology, Milan
  - name: Alessandro Guida, PhD
    affiliation: European Institute of Oncology, Milan
date: "`r Sys.Date()`"
output: 
  html_document:
...
# THIS SECTION IS NEEDED IF WE WANT TO INCLUDE THE RMD FILE AS A VIGNETTE IN THE R PACKAE
...
# abstract: >
# 
#   Design and simulation of a basket clincial trial using the R package PTD (Precision 
#   Trial Designer). 
# vignette: >
...
PTD_panel <- readRDS(file = "../Temp/PTD_panel.rds")
```
...
# svg(filename="../Figures/fig2B.svg", 
#     #width=7,  
#     #height=4, 
#     pointsize=12)
# 
...
```{r, message=FALSE, include=FALSE}
ggsave(filename="../Figures/fig2E.svg", plot=last_plot(), device = "svg")
```
...
```{r, message=FALSE, include=FALSE}
ggsave(filename="../Figures/fig2G.svg"
       , plot=last_plot()
       , device = "svg"
       , width=12
       , height=8
...
ggsave(filename="../Figures/fig3C.svg", plot=last_plot(), device = "svg")
```
...
<!-- # write -->
<!-- write.csv(dfs, file="../external_resources/cosmic_df.csv") -->
