...
1. **Simulate the panel "detected fraction"** (defined as the number of patients with at least one alteration detectable by the genomic panel) in different tumor types.
...
PTD_detection_image <- dtpow %>%
  ...
  ggtitle("Overall detected fraction") +
  annotate("text"
           , x=n_alterations
...
#### Rank genes in the design in terms of genomic space/detected fraction {.tabset}
